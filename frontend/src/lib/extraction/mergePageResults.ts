...
function parseSet(raw: Record<string, unknown>, globalSetIndex: number): ExtractionSetDraft {
...
export function mergePageResults(
...
): { pages: ExtractionPage[]; sets: ExtractionSetDraft[] } {
  ...
  return { pages: pagesOut, sets: allSets };
}
